...
<div class="rmagic" id="rm_front_sub_tabs" style="display: none;"> 
    ...
    <div class="operationsbar">
        ...
        <div class="nav">
                ...
                {
                    ?>
                    <div class="rmtabs_head" title="<?php echo RM_UI_Strings::get('LABEL_MY_DETAILS'); ?>" data-rmt-tabcontent="#rm_my_details_tab">
                        <i class="material-icons">account_box</i>
                            <?php echo RM_UI_Strings::get('LABEL_MY_DETAILS'); ?></div>
                    <?php
                }
                ?>
                <div class="rmtabs_head" title="<?php echo RM_UI_Strings::get('LABEL_MY_SUBS'); ?>" data-rmt-tabcontent="#rm_my_sub_tab">
                    <i class="material-icons">assignment_turned_in</i>
                        <?php echo RM_UI_Strings::get('LABEL_MY_SUBS'); ?></div>
                
                <div class="rmtabs_head" title="<?php echo RM_UI_Strings::get('LABEL_PAY_HISTORY'); ?>" data-rmt-tabcontent="#rm_my_pay_tab">
                ...
                if (!is_user_logged_in())
                {
                    ...
                    <div class="rmtabs_head" title="Logout"><i class="material-icons">exit_to_app</i><a href="<?php echo wp_logout_url( get_permalink() );?>">Logout</a></div>
                    <?php
                    }
                ?>
        ...
        <div class="rmagic-table" id="rm_my_pay_tab">
            ...
            <?php 
                if(empty($data->payments)){
                    _e('You have not made any payment transactions yet.','registrationmagic-gold');
                }
            ?>
