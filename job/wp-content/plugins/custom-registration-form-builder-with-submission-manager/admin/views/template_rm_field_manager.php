            ...
            <div id="rm_form_page_tabs">
                    ...
                    <div class="field-selector-pills">
                          ...
                          <div class="rm-field-manager-sorting-tip">
                            ...
                            <div class="rm-field-manager-sorting"><?php _e('Use grab handles to sort order','custom-registration-form-builder-with-submission-manager'); ?></div>
                                    </div>
                                                        ...
                                                        <div class="rm-slab-buttons rm-premium-option-popup-wrap">
                                                            ...
                                                            <?php if ($field_data->is_field_primary == 1 && (empty($field_data->is_deletion_allowed)) && strtolower($field_data->field_type)=="username"): ?>
                                                                ...
                                                                <div class="rm-premium-option-popup" style="display:none">
                                                                  ...
                                                                  <span class="rm_buy_pro_inline"><?php printf(__('To unlock removing Username field (and many more features), please upgrade <a href="%s" target="blank">Click here</a>', 'custom-registration-form-builder-with-submission-manager'), 'https://registrationmagic.com/comparison/'); ?> </span>
                                                                </div>
                        ...
                        <div class="rm-field-submit-field-holder">
                            <div class="rm-field-submit-field">
                                <div class="rm-field-submit-field-btn-container rm-field-btn-align-<?php echo $btn_align; ?>">
                                    ...
                                    <div class="rm-field-sub-btn rm_field_btn" id="rm_field_sub_button" title="<?php _e('Click to edit button label', 'custom-registration-form-builder-with-submission-manager') ?>" contenteditable="true" spellcheck="false">
                            ...
                            <div class="rm-field-submit-field-hint"><?php _e('Click on buttons to edit label','custom-registration-form-builder-with-submission-manager'); ?></div>
                        </div>
                        <!-- End: Submit Field -->
    ...
    <!--- Password delete PopUp -->
        <div id="rm-userpassword-delete" class="rm-modal-view" style="display:none">
            ...
            <div class="rm-modal-wrap">
                ...
                <div class="rm-modal-container">
                    <?php _e('You are about to remove Password field from this form. Password field will be autogenerated and emailed to the user on successful registration. Do you wish to proceed?', 'custom-registration-form-builder-with-submission-manager'); ?>
                </div>
                <div class="rm-password-delete-actions">
                        <input type="button" onclick="userpassword_delete(true,'#rm-userpassword-delete')" value="<?php _e('Yes, Remove Password', 'custom-registration-form-builder-with-submission-manager'); ?>" />
                        <input type="button" onclick="jQuery('#rm-userpassword-delete').toggle()" value="<?php _e('No, Keep Password', 'custom-registration-form-builder-with-submission-manager'); ?>" />
                    </div>
