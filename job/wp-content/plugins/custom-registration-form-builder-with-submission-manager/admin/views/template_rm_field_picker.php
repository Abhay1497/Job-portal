...
<div class="field-selector-pills">
    ...
    <div class="rm-field-tabs-row rm-fields-tab-woo rm-dbfl">
        ...
        <?php else: ?>
        <div class="rm-field-tab-cat"> <?php echo __('WooCommerce Fields (Not Installed or Inactive)', 'custom-registration-form-builder-with-submission-manager'); ?></div>
        <div id="rm_wc_fields_tab">
 ...
 <div class="rm-fields-disabled rm-fields-disabled-notice rm-dbfl">*<?php _e('Premium Fields','custom-registration-form-builder-with-submission-manager') ?></div>
