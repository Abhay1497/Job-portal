<?php add_thickbox(); $buttons= $data['buttons'];?>
            ...
            <div id="rm_form_page_tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                ...
                <div class="field-selector-pills">
                    ...
                    <div class="rm-field-manager-sorting-tip">
                        ...
                        <div class="rm-field-manager-sorting"><?php echo _e('Use grab handles to sort order', 'custom-registration-form-builder-with-submission-manager'); ?></div>
                        ...
                        <div class="rm-field-submit-field-holder">
                            ...
                            <div class="rm-field-submit-field">
                                ...
                                <div class="rm-field-submit-field-btn-container rm-field-btn-align-<?php echo $btn_align; ?>">
                                    ...
                                    <div class="rm-field-next-btn rm_field_btn" id="rm_field_login_button" title="<?php _e('Click to edit button label', 'custom-registration-form-builder-with-submission-manager'); ?>" contenteditable="true" spellcheck="false">

                                        <?php echo htmlentities(stripslashes($login_label)); ?>

                                    </div>

                                    &#8203;

                                    <div class="rm-field-sub-btn rm_field_btn" id="rm_field_register_button" title="<?php _e('Click to edit button label', 'custom-registration-form-builder-with-submission-manager') ?>" contenteditable="true" spellcheck="false">

                                        <?php echo htmlentities(stripslashes($register_label)); ?>
                            ...
                            <div class="rm-field-submit-field-hint"><?php echo _e('Click on buttons to edit label', 'custom-registration-form-builder-with-submission-manager'); ?></div>
