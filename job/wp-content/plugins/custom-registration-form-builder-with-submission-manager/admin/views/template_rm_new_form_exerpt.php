    ...
    <div class="rm-create-new-from">
            ...
            <div class="rm-select-form-type">
                ...
                <div id="rm_reg_form_selector" class="rm-form-type rm-form-type-selected" onclick="rm_on_form_type_selected(this)">
                    ...
                    <div class="rm-form-type-head"><span ><svg width="100%" height="100%" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
                            ...
                            </svg></span><?php _e('User Registration Form','custom-registration-form-builder-with-submission-manager'); ?>
                        </div>
                    <div class="rm-form-type-info"><?php _e('Initially, the form will be created with Username, Password and Email fields. You can later edit them, add more fields and customize the form.','custom-registration-form-builder-with-submission-manager'); ?></div>
                ...
                <div id="rm_contact_form_selector" class="rm-form-type" onclick="rm_on_form_type_selected(this)">
                    ...
                    <div class="rm-form-type-head"><span ><svg width="100%" height="100%" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
                        ...
                        <?php _e('Contact Form/ Other Form','custom-registration-form-builder-with-submission-manager'); ?></div>
                    <div class="rm-form-type-info"><?php _e("Initially, the form will be created with only Email field. You can later edit it, add more fields and customize the form.",'custom-registration-form-builder-with-submission-manager'); ?>  </div>
                </div>
        ...
        <div class="rmrow">
            ...
            <div class="rm-newform-footnote">
                ...
                <?php _e("Username and Password fields will not appear to existing users. But they can still submit the form if you have allowed multiple submissions.",'custom-registration-form-builder-with-submission-manager'); ?>
