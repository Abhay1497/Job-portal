    ...
    <div class="rm-support-container">
        ...
        <div class="rm-support-block rm-difl">
            <div class="rm-support-block-head rm-dbfl">
                <div class="rm-support-block-icon rm-difl"> <img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__))) . 'images/rm-support-resources.png'; ?>"></div>
                  <div class="rm-support-block-title rm-difr"><?php _e('Resources', 'custom-registration-form-builder-with-submission-manager'); ?></div>  
            </div>
        ...
        <div class="rm-support-block-head rm-dbfl">
                <div class="rm-support-block-icon rm-difl"> <img src="<?php echo plugin_dir_url(dirname(dirname(__FILE__))) . 'images/rm-support-faq.png'; ?>"></div>
                  <div class="rm-support-block-title rm-difr"><?php _e('FAQs', 'custom-registration-form-builder-with-submission-manager'); ?></div>  
            </div>
		...
		<div class="rm-support-faq-toggle">
                ...
                <div class="rm-support-faq-row">
		  <div class="rm-support-faq-toggle">
                       <a href="https://registrationmagic.com/how-add-space-between-wordpress-form-fields/" target="_blank">  <?php _e('How to change position of the labels on your forms?', 'custom-registration-form-builder-with-submission-manager'); ?></a>
		 </div>
                </div>
		  ...
		  <div class="rm-support-faq-toggle">
                ...
                <div class="rm-support-faq-row">
		  <div class="rm-support-faq-toggle">
                       <a href="https://registrationmagic.com/add-conditions-to-fields-in-wordpress-form/" target="_blank">  <?php _e('How to make a field mandatory in a form?', 'custom-registration-form-builder-with-submission-manager'); ?></a>
		 </div>
                </div>
		  ...
		  <div class="rm-support-faq-toggle">
                ...
                <div class="rm-support-faq-row">
		  <div class="rm-support-faq-toggle">
                       <a href="https://registrationmagic.com/publish-registration-forms-and-display-registered-users/" target="_blank">  <?php _e('How to publish a login form or a button on your site?', 'custom-registration-form-builder-with-submission-manager'); ?></a>
		 </div>
                </div>
